...
Evaluates: Whether backup encryption is configured via Key Vault or infrastructure encryption
"""
import json
...
def evaluate(data):
    ...
    try:
        encryption = data.get('properties', {}).get('encryption', {})
        is_encrypted = encryption.get('keyVaultProperties') is not None or encryption.get('infrastructureEncryption') == 'Enabled'
        return {"isBackupEncrypted": is_encrypted, "encryptionConfig": encryption}
