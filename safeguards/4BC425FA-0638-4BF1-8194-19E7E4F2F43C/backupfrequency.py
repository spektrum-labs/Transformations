...
Evaluates: Whether backup frequency meets daily minimum (schedule frequency <= 1440 minutes)
"""
import json
    ...
    return {
        ...
        "additionalInfo": {
            ...
            "metadata": {
                ...
                "schemaVersion": "1.0",
                "transformationId": "backupFrequency",
...
def transform(input):
    """Evaluates whether backup frequency meets daily minimum."""
