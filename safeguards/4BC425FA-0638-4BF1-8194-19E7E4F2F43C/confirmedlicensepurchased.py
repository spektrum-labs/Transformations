...
def transform(input):
    ...
    try:
        ...
        if license_purchased:
            pass_reasons.append("License has been purchased for Backup Provider")
        else:
            fail_reasons.append("License has not been purchased")
            recommendations.append("Purchase license for Backup Provider")
