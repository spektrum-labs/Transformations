...
Evaluates: Whether SPF DNS record is valid.
"""
import json
...
def create_response(result, validation=None, pass_reasons=None, fail_reasons=None,
    ...
    return {
        ...
        "additionalInfo": {
            ...
            "metadata": {"evaluatedAt": datetime.utcnow().isoformat() + "Z", "schemaVersion": "1.0", "transformationId": "isSPFConfigured", "vendor": "Microsoft Defender for Office 365", "category": "Email Security"}
        }
    }
...
def evaluate(data):
    ...
    try:
        record = data.get('spf_record', '')
        has_spf = bool(record and 'v=spf1' in record)
        return {"isSPFConfigured": has_spf, "record": record}
...
def transform(input):
    """
    Evaluates SPF DNS record validity.
