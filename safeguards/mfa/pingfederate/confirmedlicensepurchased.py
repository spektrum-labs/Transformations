...
Evaluates: A valid, non-expired PingFederate license exists
"""
import json
...
def create_response(result, validation=None, pass_reasons=None, fail_reasons=None,
    ...
    return {
        ...
        "additionalInfo": {
            ...
            "metadata": {"evaluatedAt": datetime.utcnow().isoformat() + "Z", "schemaVersion": "1.0", "transformationId": "confirmedLicensePurchased", "vendor": "PingFederate", "category": "Multi-Factor Authentication"}
        }
    }
...
def evaluate(data):
    ...
    try:
        ...
        # Check license record exists
        license_id = data.get("id")
        if not license_id:
            return {"confirmedLicensePurchased": False, "reason": "No license record found"}
        ...
        return {
            ...
            "daysRemaining": (expiration_date - today).days
        }
