...
Category: Endpoint Security / Licensing

Evaluates if the license has been purchased for the endpoint protection platform.
"""
...
def transform(input):
    ...
    try:
        ...
        if license_purchased:
            pass_reasons.append("License has been purchased for endpoint protection platform")
        else:
            fail_reasons.append("License has not been purchased")
            recommendations.append("Purchase license for endpoint protection platform")
