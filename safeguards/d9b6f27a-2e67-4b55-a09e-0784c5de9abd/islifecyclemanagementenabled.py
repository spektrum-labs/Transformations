...
Evaluates if lifecycle management is enabled for the identity provider.
"""
...
def transform(input):
    ...
    try:
        ...
        if is_enabled:
            ...
            fail_reasons.append("Lifecycle management is not enabled")
            recommendations.append("Enable lifecycle management in Azure AD Identity Governance")
        ...
        return create_response(
            ...
            input_summary={"lifecycleEnabled": is_enabled}
        )
