...
def transform(input):
    ...
    try:
        ...
        if is_enabled:
            pass_reasons.append(f"Security Center integration enabled with {len(submissions)} threat submissions found")
        else:
            fail_reasons.append("No Security Center integration detected")
