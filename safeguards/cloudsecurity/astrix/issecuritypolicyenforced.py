...
def transform(input):
    """
    Evaluates isSecurityPolicyEnforced for Astrix Security

    Checks: Whether NHI security policies are configured and enforced
    API Source: {baseURL}/v1/policies
    Pass Condition: At least one security policy is active and enforced
