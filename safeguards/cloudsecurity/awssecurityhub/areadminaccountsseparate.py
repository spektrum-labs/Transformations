...
Mapping: IAM.1 (no customer-managed policy grants full "*:*" admin) and IAM.4
(no root user access key), i.e. privileged access is not held by everyday identities.

Evaluates AWS Security Hub control(s) IAM.1, IAM.4 from the getSecurityHubComplianceAWS
...
CONTROL_IDS = ['IAM.1', 'IAM.4']
TRANSFORM_ID = "areadminaccountsseparate"
