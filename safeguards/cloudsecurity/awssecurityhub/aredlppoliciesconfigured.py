...
Mapping: Macie.1 (Amazon Macie enabled) and Macie.2 (automated sensitive data
discovery enabled), AWS's managed sensitive-data discovery service.

Evaluates AWS Security Hub control(s) Macie.1, Macie.2 from the getSecurityHubComplianceAWS
...
CONTROL_IDS = ['Macie.1', 'Macie.2']
TRANSFORM_ID = "aredlppoliciesconfigured"
