...
def transform(input):
    """
    Evaluates isSecurityPolicyEnforced for Entro Security

    Checks: Whether secrets security policies are configured and enforced
    API Source: {baseURL}/v1/policies
    Pass Condition: At least one secrets management policy is active and enforced
