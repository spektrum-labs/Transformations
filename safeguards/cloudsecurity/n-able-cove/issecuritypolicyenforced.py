...
def transform(input):
    """
    Evaluates isSecurityPolicyEnforced for N-able Cove Data Protection

    Checks: Whether backup policies are configured and enforced
    API Source: {baseURL}/api/v1/backup-policies
    Pass Condition: At least 1 active backup policy exists
