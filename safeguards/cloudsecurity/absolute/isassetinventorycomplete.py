...
def transform(input):
    ...
    Checks: Whether the Absolute device inventory contains managed endpoints
    API Source: {baseURL}/v3/reporting/devices
    Pass Condition: At least one device is present and reporting
