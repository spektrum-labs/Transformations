...
Evaluates isSecurityPolicyEnforced for Lacework (FortiCNAPP)
"""
...
def create_response(result, validation=None, pass_reasons=None, fail_reasons=None,
    ...
    return {
        ...
        "additionalInfo": {
            ...
            "metadata": {"evaluatedAt": datetime.utcnow().isoformat() + "Z", "schemaVersion": "1.0", "transformationId": "isSecurityPolicyEnforced", "vendor": "Lacework", "category": "Cloud Security"}
        }
    }
...
def transform(input):
    ...
    try:
        ...
        enabled = [
            ...
            or str(p.get("enabled", "")).lower() in ("true", "1")
            or str(p.get("policyEnabled", "")).lower() in ("true", "1")
        ]
