...
Evaluates: Check that at least one prevention policy has 'enabled: true' in the resources
           array returned from /policy/combined/prevention/v1.
"""
import json
...
def transform(input):
    ...
    try:
        ...
        if result_value:
            ...
            pass_reasons.append(
                "Enabled policies: " + str(eval_result.get("enabledPoliciesCount", 0)) +
            ...
            recommendations.append("Enable at least one prevention policy in the CrowdStrike Falcon console")
        ...
        return create_response(
            ...
            input_summary={
                ...
                "enabledPoliciesCount": eval_result.get("enabledPoliciesCount", 0)
            }
        )
    except Exception as e:
        return create_response(
