...
def transform(input):
    ...
    try:
        ...
        if is_enabled:
            ...
            fail_reasons.append("Lifecycle management configuration not found")
            recommendations.append("Enable lifecycle management in the IDP")
        ...
        return create_response(
            ...
            input_summary={"lifecycleManagementConfigured": is_enabled}
        )
