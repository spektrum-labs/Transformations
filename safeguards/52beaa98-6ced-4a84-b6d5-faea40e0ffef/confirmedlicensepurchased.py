...
Evaluates if the license has been purchased for Compliance Management.
"""
...
def transform(input):
    ...
    try:
        ...
        if license_purchased:
            pass_reasons.append("License has been purchased for Compliance Management")
        else:
            fail_reasons.append("License has not been purchased")
            recommendations.append("Purchase license for Compliance Management")
