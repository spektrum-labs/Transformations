def transform(input):
    """
    Check if Microsoft Unified Audit Logging is enabled

    Parameters:
        input (dict): The JSON data containing ms365_logging API response

    Returns:
        dict: A dictionary with the isUnifiedAuditLoggingEnabled evaluation result
    """

    criteria_key = "isUnifiedAuditLoggingEnabled"
