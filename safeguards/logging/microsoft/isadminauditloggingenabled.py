def transform(input):
    """
    Check if log entries are created for Microsoft tenant changes

    Parameters:
        input (dict): The JSON data containing ms365_logging API response

    Returns:
        dict: A dictionary with the isAdminAuditLoggingEnabled evaluation result
    """

    criteria_key = "isAdminAuditLoggingEnabled"
