def transform(input):
    """
    Check if mailbox audit logging is enabled

    Parameters:
        input (dict): The JSON data containing ms365_logging API response

    Returns:
        dict: A dictionary with the isMailboxAuditLoggingEnabled evaluation result
    """

    criteria_key = "isMailboxAuditLoggingEnabled"
