...
def transform(input):
    ...
    Checks: Whether TheHive platform status and Cortex analyzer connectivity is active
    API Source: /api/v1/status
    Pass Condition: Status endpoint returns valid state with Cortex analyzers available
