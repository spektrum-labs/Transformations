"""
Transformation: networkSegmentationActive
Vendor: Cisco Meraki  |  Category: Network Security
Evaluates: Whether VLAN segmentation is configured with at least 2 VLANs
"""
import json
...
def create_response(result, validation=None, pass_reasons=None, fail_reasons=None,
    ...
    return {
        ...
        "additionalInfo": {
            ...
            "metadata": {"evaluatedAt": datetime.utcnow().isoformat() + "Z", "schemaVersion": "1.0", "transformationId": "networkSegmentationActive", "vendor": "Cisco Meraki", "category": "Network Security"}
        }
    }
...
def transform(input):
    criteriaKey = "networkSegmentationActive"
    try:
