...
Evaluates: Whether the Cisco Meraki network security license is active
"""
import json
...
def create_response(result, validation=None, pass_reasons=None, fail_reasons=None,
    ...
    return {
        ...
        "additionalInfo": {
            ...
            "metadata": {"evaluatedAt": datetime.utcnow().isoformat() + "Z", "schemaVersion": "1.0", "transformationId": "confirmedLicensePurchased", "vendor": "Cisco Meraki", "category": "Network Security"}
        }
    }
...
def evaluate(data):
    try:
        ...
        is_active = status.lower() in ['ok', 'active', 'recently queued']
        return {"confirmedLicensePurchased": is_active, "licenseStatus": status}
