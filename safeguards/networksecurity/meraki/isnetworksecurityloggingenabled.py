...
Evaluates: Whether syslog servers are configured for network security logging
"""
import json
...
def evaluate(data):
    try:
        ...
        return {"isNetworkSecurityLoggingEnabled": len(servers) > 0, "syslogServerCount": len(servers)}
