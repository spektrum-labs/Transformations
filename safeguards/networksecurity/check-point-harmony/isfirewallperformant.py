...
Evaluates isFirewallPerformant for Check Point Harmony (Network Security)
"""
...
def create_response(result, validation=None, pass_reasons=None, fail_reasons=None,
    ...
    return {
        ...
        "additionalInfo": {
            ...
            "metadata": {"evaluatedAt": datetime.utcnow().isoformat() + "Z", "schemaVersion": "1.0", "transformationId": "isFirewallPerformant", "vendor": "Check Point Harmony", "category": "Network Security"}
        }
    }
...
def transform(input):
    ...
    try:
        ...
        # Harmony Endpoint status returns service health metrics
