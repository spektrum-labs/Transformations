...
Evaluates isFirewallPerformant for Check Point XDR/XPR (Network Security)
"""
...
def create_response(result, validation=None, pass_reasons=None, fail_reasons=None,
    ...
    return {
        ...
        "additionalInfo": {
            ...
            "metadata": {"evaluatedAt": datetime.utcnow().isoformat() + "Z", "schemaVersion": "1.0", "transformationId": "isFirewallPerformant", "vendor": "Check Point Xdr Xpr", "category": "Network Security"}
        }
    }
...
def transform(input):
    ...
    try:
        ...
        # XDR/XPR status returns service health and resource metrics
