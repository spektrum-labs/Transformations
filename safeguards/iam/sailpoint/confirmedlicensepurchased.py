...
def create_response(result, validation=None, pass_reasons=None, fail_reasons=None,
    ...
    return {
        ...
        "additionalInfo": {
            ...
            "metadata": {"evaluatedAt": datetime.utcnow().isoformat() + "Z", "schemaVersion": "1.0", "transformationId": "confirmedLicensePurchased", "vendor": "Sailpoint", "category": "Identity & Access Management"}
        }
    }
...
def transform(input):
    ...
    try:
        ...
        return create_response(
            ...
            result={"confirmedLicensePurchased": result, "orgName": str(org_name)},
