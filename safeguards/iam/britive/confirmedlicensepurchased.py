...
Evaluates: Whether a valid, active Britive tenant exists with users present.
"""
import json
...
def create_response(result, validation=None, pass_reasons=None, fail_reasons=None,
    ...
    return {
        ...
        "additionalInfo": {
            ...
            "metadata": {"evaluatedAt": datetime.utcnow().isoformat() + "Z", "schemaVersion": "1.0", "transformationId": "confirmedLicensePurchased", "vendor": "Britive", "category": "Identity & Access Management"}
        }
    }
...
def evaluate(data):
    ...
    try:
        # Britive /api/users returns { "count": N, "data": [...] }
