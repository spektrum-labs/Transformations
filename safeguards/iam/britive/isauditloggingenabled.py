...
Evaluates: Whether Britive audit logging is active and producing records.
"""
import json
...
def create_response(result, validation=None, pass_reasons=None, fail_reasons=None,
    ...
    return {
        ...
        "additionalInfo": {
            ...
            "metadata": {"evaluatedAt": datetime.utcnow().isoformat() + "Z", "schemaVersion": "1.0", "transformationId": "isAuditLoggingEnabled", "vendor": "Britive", "category": "Identity & Access Management"}
        }
    }
...
def _evaluate(data):
    ...
    try:
        ...
        if isinstance(records, list) and len(records) > 0:
            result = True
            # Extract the most recent log timestamp for diagnostics
            first_record = records[0]
            last_event_timestamp = first_record.get("timestamp", first_record.get("eventTime"))
