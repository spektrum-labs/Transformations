...
def transform(input):
    ...
    try:
        ...
        if all_encrypted:
            ...
            fail_reasons.append("Not all backups are encrypted")
            recommendations.append("Enable encryption for all backup storage")
        ...
        return create_response(
            ...
            input_summary={"encryptionVerified": all_encrypted}
        )
