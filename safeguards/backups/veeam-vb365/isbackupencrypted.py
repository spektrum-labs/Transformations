"""
isBackupEncrypted - Veeam Backup for Microsoft 365

Every object storage repository has objectStorageEncryptionEnabled true (GET /v8/BackupRepositories).
...
def evaluate(input):
    ...
    return respond(True, "All " + str(len(objs)) + " object storage repositories are encrypted")
