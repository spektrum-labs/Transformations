# isbackupclientversioncurrent.py - NetBackup (Cohesity NetBackup, formerly Veritas NetBackup)
#
...
def transform(input):
    """
    Returns isBackupClientVersionCurrent = True when NetBackup reports 100% of clients on the latest NetBackup
    version (clientPercentageWithLatestNbuVersion.currentConfigState 100, with totalHosts above 0).
    """
    key = "isBackupClientVersionCurrent"
    SETTING = "clientPercentageWithLatestNbuVersion"
