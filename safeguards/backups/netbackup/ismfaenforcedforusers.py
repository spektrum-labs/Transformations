# ismfaenforcedforusers.py - NetBackup (Cohesity NetBackup, formerly Veritas NetBackup)
#
...
def transform(input):
    """
    Returns isMFAEnforcedForUsers = True when NetBackup reports MFA enforced for its users
    (securitySettingsDetail.mfaEnforced.currentConfigState is true).
    """
