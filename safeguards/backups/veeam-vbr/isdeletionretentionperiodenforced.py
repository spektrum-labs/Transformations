"""
isDeletionRetentionPeriodEnforced - Veeam Backup & Replication

Every enabled backup job's target enforces an immutability period of at least 1 day, so restore points cannot be deleted early.
