# isdatalockcompliancemodeenabled.py - Cohesity DataProtect (Helios / Cohesity Data Cloud)
#
...
def transform(input):
    """
    Returns isDataLockComplianceModeEnabled = True when every policy used by an active protection group locks its
    regular backups in Compliance mode (dataLockConfig.mode "Compliance", positive duration). Administrative mode
    (which a Data Security Officer can shorten) or no lock is False.
    """
