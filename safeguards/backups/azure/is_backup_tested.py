...
Checks whether any Azure backup restore operations have been executed,
indicating backups have been tested for recoverability.

Data source: Azure Resource Graph query (getRestoreJobs) returning backup
jobs filtered to Restore operations with status, start/end times, and workload type.
"""
