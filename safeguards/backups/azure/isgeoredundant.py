...
Evaluates: Whether backup storage is configured as geo-redundant
"""
import json
    ...
    return {
        ...
        "additionalInfo": {
            ...
            "metadata": {
                ...
                "schemaVersion": "1.0",
                "transformationId": "isGeoRedundant",
...
def transform(input):
    """Checks if backup storage is geo-redundant."""
    criteriaKey = "isGeoRedundant"
    try:
