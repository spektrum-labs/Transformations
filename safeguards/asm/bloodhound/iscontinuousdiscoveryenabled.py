...
def create_response(result, validation=None, pass_reasons=None, fail_reasons=None,
    ...
    return {
        ...
        "additionalInfo": {
            ...
            "metadata": {"evaluatedAt": datetime.utcnow().isoformat() + "Z", "schemaVersion": "1.0", "transformationId": "isContinuousDiscoveryEnabled", "vendor": "Bloodhound", "category": "Attack Surface Management"}
        }
    }
    ...
    try:
        ...
        if not isinstance(asset_groups, list):
            return create_response(
                ...
                fail_reasons=["isContinuousDiscoveryEnabled check failed"]
            )
