...
def evaluate(data):
    folders = list_items(data, "smartfolders", "smartFolders", "folders", "items", "data")
    if folders is None:
...
def transform(input):
    return run_criterion(input, "isSavedQueryMonitoringEnabled", evaluate, "isSavedQueryMonitoringEnabled")
