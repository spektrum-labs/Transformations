...
Evaluates: a readable source list proves a live, licensed subscription behind this key
Reads: /sources
...
def transform(input):
    return run_criterion(input, "confirmedLicensePurchased", evaluate, "confirmedLicensePurchased")
