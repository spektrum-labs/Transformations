...
Vendor: Tenable  |  Category: Attack Surface Management  |  Method: getHighAssets (POST /inventory filter bd.severity_ranking is high)
Evaluates: count of assets ranked high (the response total); true when 0
...
def transform(input):
    return _run(input, "noHighFindings", evaluate, "noHighFindings")
