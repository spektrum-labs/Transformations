...
def evaluate(data):
    ...
    extras = {"assetTotal": total, "hostCount": stats.get("hostcount"), "domainCount": stats.get("domaincount"), "subdomainCount": stats.get("subdomaincount"), "ipCount": stats.get("ipcount")}
    if total is None:
