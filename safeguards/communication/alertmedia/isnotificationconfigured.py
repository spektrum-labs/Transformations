...
def transform(input):
    ...
    Checks: Whether notification templates are configured and available
    API Source: https://api.alertmedia.com/api/v3/notifications
    Pass Condition: At least one notification template or recent notification exists
