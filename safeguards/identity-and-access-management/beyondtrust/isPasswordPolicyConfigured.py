...
is defined in the BeyondTrust Password Safe system.
"""
import json
...
def evaluate(data):
    try:
        if isinstance(data, dict):
            ...
            return {"isPasswordPolicyConfigured": False, "policyCount": 0, "reason": "Unexpected type: non-dict/non-list"}
