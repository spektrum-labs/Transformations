...
def evaluate(data):
    ...
    try:
        if isinstance(data, dict):
            ...
            return {"isPasswordAutoManagementEnabled": None, "error": "required fields missing from API response: ManagedAccounts, AutoManagementFlag"}
        ...
        result = coverage >= auto_mgmt_threshold
