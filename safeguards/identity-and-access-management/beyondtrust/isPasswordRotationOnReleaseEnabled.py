...
Evaluates: Whether >= 50% of managed accounts have ChangePasswordAfterAnyReleaseFlag enabled.
"""
import json
...
def evaluate(data):
    ...
    try:
        if isinstance(data, dict):
            ...
            return {"isPasswordRotationOnReleaseEnabled": None, "error": "required fields missing from API response: ManagedAccounts, ChangePasswordAfterAnyReleaseFlag"}
        ...
        return {
            "isPasswordRotationOnReleaseEnabled": result,
            "rotationCount": rotation_count,
            "totalAccounts": total,
            "rotationPercent": rotation_pct
        }
