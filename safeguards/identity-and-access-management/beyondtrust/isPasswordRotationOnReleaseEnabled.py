...
Evaluates: Whether >= 50% of managed accounts have ChangePasswordAfterAnyReleaseFlag
set to True, ensuring passwords are rotated after every credential checkout.
"""
import json
