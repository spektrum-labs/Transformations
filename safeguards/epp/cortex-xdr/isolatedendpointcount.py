# isolatedendpointcount.py - Palo Alto Networks Cortex XDR (Endpoint Security, f1b50389)
#
...
def transform(input):
    """
    Count of endpoints currently isolated (isolate filter = isolated). None when unreadable.
    """
    key = "isolatedEndpointCount"
    ...
    try:
        ...
        n = total(data, "isolated")
        if n is None:
            return {key: None, "reason": "No readable total_count for isolated endpoints"}
        return {key: n}
