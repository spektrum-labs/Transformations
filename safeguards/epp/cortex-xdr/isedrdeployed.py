# isedrdeployed.py - Palo Alto Networks Cortex XDR (Endpoint Security, f1b50389)
#
...
def transform(input):
    """
    True when at least one Cortex XDR agent is CONNECTED (present and reporting).
    ...
    try:
        ...
        n = total(data, "connected")
        if n is None:
            return {key: False, "reason": "No readable total_count for connected endpoints"}
        return {key: n >= 1, "reason": "Connected Cortex XDR agents: %d" % n, "connectedEndpoints": n}
