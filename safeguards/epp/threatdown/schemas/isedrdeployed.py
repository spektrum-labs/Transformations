...
class EndpointItem(BaseModel):
    ...
    edr_enabled: Optional[Union[bool, str]] = Field(None, description="Whether EDR module is enabled")
    edrEnabled: Optional[Union[bool, str]] = Field(None, description="Alternate EDR enabled field")
    agent_version: Optional[str] = Field(None, description="ThreatDown agent version")
