...
Evaluates isEPPDeployed for Jamf Pro (EPP)
"""
...
def create_response(result, validation=None, pass_reasons=None, fail_reasons=None,
    ...
    return {
        ...
        "additionalInfo": {
            ...
            "metadata": {"evaluatedAt": datetime.utcnow().isoformat() + "Z", "schemaVersion": "1.0", "transformationId": "isEPPDeployed", "vendor": "Jamf", "category": "Endpoint Protection"}
        }
    }
    ...
    try:
        ...
        for c in computers:
            ...
            if general.get("managed", False):
                enrolled += 1
            elif general.get("enrolledViaAutomatedDeviceEnrollment", False):
                enrolled += 1
