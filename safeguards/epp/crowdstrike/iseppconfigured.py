def transform(input):
    ...
    try:
        ...
        # configured, so an auth-error envelope or any unrecognised body with any key
        # at all satisfied the criterion. Removed: the response must actually name one
        # of the recognised fields above.
