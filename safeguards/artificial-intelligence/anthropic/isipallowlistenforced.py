"""
Transformation: isIPAllowlistEnforced
...
METADATA = {
    "transformationId": "isIPAllowlistEnforced",
    "vendor": "Anthropic",
...
def _evaluate(input):
    ...
    if enabled_raw is _MISSING:
        return create_response(
            result={"isIPAllowlistEnforced": False, "ipAllowlistEnabled": None, "rangeCount": 0},
...
def transform(input):
    try:
        ...
        return create_response(
            result={"isIPAllowlistEnforced": False},
