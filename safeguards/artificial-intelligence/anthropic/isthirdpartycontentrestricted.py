...
def _evaluate(input):
    ...
    if refusal:
        ...
        return create_response(
            result={"isThirdPartyContentRestricted": False, "endpointReachable": False, "httpStatus": _status},
    ...
    raw = settings.get("third_party_interactive_content_enabled", _MISSING)
