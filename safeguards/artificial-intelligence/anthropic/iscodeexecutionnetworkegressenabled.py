...
def evaluate(input):
    ...
    if refusal:
        ...
        return create_response(
            result={"isCodeExecutionNetworkEgressEnabled": False, "endpointReachable": False, "httpStatus": refusal_status},
    ...
    egress_on = as_bool(egress_raw)
    exec_on = None if exec_raw is MISSING else as_bool(exec_raw)
