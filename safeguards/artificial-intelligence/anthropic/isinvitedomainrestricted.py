...
def evaluate(input):
    ...
    if refusal:
        ...
        return create_response(
            result={"isInviteDomainRestricted": False, "endpointReachable": False, "httpStatus": refusal_status},
    ...
    domains = settings.get("allowed_invite_domains", MISSING)

    if domains is MISSING:
        return create_response(
