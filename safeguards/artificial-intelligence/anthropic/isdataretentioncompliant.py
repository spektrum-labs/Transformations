...
def evaluate(input):
    ...
    if refusal:
        ...
        return create_response(
            result={"isDataRetentionCompliant": False, "endpointReachable": False, "httpStatus": refusal_status},
    ...
    periods = settings.get("data_retention_periods", MISSING)

    if periods is MISSING:
        return create_response(
