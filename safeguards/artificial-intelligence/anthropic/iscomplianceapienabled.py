...
def evaluate(input):
    ...
    if refusal:
        ...
        return create_response(
            result={"isComplianceAPIEnabled": False, "endpointReachable": False, "httpStatus": refusal_status},
    ...
    if not items:
        return create_response(
            result={"isComplianceAPIEnabled": False, "activityCount": 0,
...
def transform(input):
    try:
        ...
        return create_response(
            result={"isComplianceAPIEnabled": False},
