...
Evaluates: Whether the dope.swg Secure Web Gateway is actively enforcing
"""
import json
...
def create_response(result, validation=None, pass_reasons=None, fail_reasons=None,
    ...
    return {
        ...
        "additionalInfo": {
            ...
            "metadata": {"evaluatedAt": datetime.utcnow().isoformat() + "Z", "schemaVersion": "1.0", "transformationId": "isFirewallEnabled", "vendor": "Dope Security", "category": "Firewall"}
        }
    }
...
def evaluate(data):
    ...
    try:
        ...
        if not isinstance(endpoints, list):
            return {"isFirewallEnabled": False, "error": "Unexpected endpoints format"}

        total = len(endpoints)
        if total == 0:
            return {"isFirewallEnabled": False, "healthyEndpoints": 0, "totalEndpoints": 0,
                    "reason": "No endpoints enrolled in dope.swg"}
        ...
        for ep in endpoints:
            ...
            # Handle adminSetState as dict or direct boolean
