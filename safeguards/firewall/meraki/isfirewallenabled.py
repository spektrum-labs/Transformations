...
Evaluates: Whether L3 firewall rules are configured
"""
import json
...
def create_response(result, validation=None, pass_reasons=None, fail_reasons=None,
    ...
    return {
        ...
        "additionalInfo": {
            ...
            "metadata": {"evaluatedAt": datetime.utcnow().isoformat() + "Z", "schemaVersion": "1.0", "transformationId": "isFirewallEnabled", "vendor": "Cisco Meraki", "category": "Firewall"}
        }
    }
...
def evaluate(data):
    try:
        ...
        return {"isFirewallEnabled": len(rules) > 0, "ruleCount": len(rules)}
