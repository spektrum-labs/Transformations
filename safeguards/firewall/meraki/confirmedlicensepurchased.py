...
Evaluates: Whether the Cisco Meraki firewall license is active
"""
import json
...
def create_response(result, validation=None, pass_reasons=None, fail_reasons=None,
    ...
    return {
        ...
        "additionalInfo": {
            ...
            "metadata": {"evaluatedAt": datetime.utcnow().isoformat() + "Z", "schemaVersion": "1.0", "transformationId": "confirmedLicensePurchased", "vendor": "Cisco Meraki", "category": "Firewall"}
        }
    }
...
def evaluate(data):
    try:
        ...
        return {"confirmedLicensePurchased": status.lower() in ['ok', 'active'], "licenseStatus": status}
