...
Evaluates: Whether firewall has custom rules beyond default deny
"""
import json
...
def create_response(result, validation=None, pass_reasons=None, fail_reasons=None,
    ...
    return {
        ...
        "additionalInfo": {
            ...
            "metadata": {"evaluatedAt": datetime.utcnow().isoformat() + "Z", "schemaVersion": "1.0", "transformationId": "isFirewallConfigured", "vendor": "Cisco Meraki", "category": "Firewall"}
        }
    }
...
def evaluate(data):
    try:
        ...
        return {"isFirewallConfigured": len(rules) > 1, "totalRules": len(rules)}
