...
Evaluates isPublicNetworkAccessDisabled for Microsoft
"""
...
def create_response(result, validation=None, pass_reasons=None, fail_reasons=None,
    ...
    return {
        ...
        "additionalInfo": {
            ...
            "metadata": {"evaluatedAt": datetime.utcnow().isoformat() + "Z", "schemaVersion": "1.0", "transformationId": "isPublicNetworkAccessDisabled", "vendor": "Microsoft", "category": "Encryption"}
        }
    }


def transform(input):
    criteriaKey = "isPublicNetworkAccessDisabled"
    ...
    try:
        ...
        if isinstance(public_access, str) and public_access.lower() == "disabled":
            return create_response(
                result={"isPublicNetworkAccessDisabled": True},
        ...
        return create_response(
            ...
            result={"isPublicNetworkAccessDisabled": False},

            validation=validation,

            fail_reasons=["isPublicNetworkAccessDisabled check failed"]
