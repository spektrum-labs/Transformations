...
def create_response(result, validation=None, pass_reasons=None, fail_reasons=None,
    ...
    return {
        ...
        "additionalInfo": {
            ...
            "metadata": {"evaluatedAt": datetime.utcnow().isoformat() + "Z", "schemaVersion": "1.0", "transformationId": "isAlertingConfigured", "vendor": "Opencti", "category": "Threat Intelligence"}
        }
    }
                    ...
                    for edge in edges:
                        ...
                        if isinstance(notifiers, list) and len(notifiers) > 0:
                            return create_response(
                                result={"isAlertingConfigured": True},
