...
def create_response(result, validation=None, pass_reasons=None, fail_reasons=None,
    ...
    return {
        ...
        "additionalInfo": {
            ...
            "metadata": {"evaluatedAt": datetime.utcnow().isoformat() + "Z", "schemaVersion": "1.0", "transformationId": "isThreatAnalysisEnabled", "vendor": "Opencti", "category": "Threat Intelligence"}
        }
    }
            ...
            if isinstance(reports, dict):
                ...
                if isinstance(edges, list) and len(edges) > 0:
                    return create_response(
                        result={"isThreatAnalysisEnabled": True},
