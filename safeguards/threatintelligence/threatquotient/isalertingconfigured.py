...
def transform(input):
    """
    Evaluates isAlertingConfigured for ThreatQuotient.

    Checks: Whether active indicators are present and being tracked
    API Source: GET https://{hostname}/api/indicators?status=Active
    Pass Condition: At least one active indicator is returned
