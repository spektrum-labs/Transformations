...
def transform(input):
    """
    Evaluates isThreatFeedActive for Intezer.

    Checks: Analysis history is accessible and returning search results.
    API Source: GET https://analyze.intezer.com/api/v2-0/history/search
    Pass Condition: Response contains analysis history records.
