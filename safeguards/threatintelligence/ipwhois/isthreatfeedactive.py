...
def transform(input):
    """
    Evaluates isThreatFeedActive for IPWHOIS.

    Checks: IP geolocation data is returned successfully from the lookup endpoint.
    API Source: GET https://ipwhois.app/json/8.8.8.8
    Pass Condition: Response contains valid IP, country, and geolocation fields.
