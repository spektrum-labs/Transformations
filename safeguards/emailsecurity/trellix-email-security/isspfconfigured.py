...
Evaluates isSPFConfigured for Trellix Email Security (Email Security)
"""
...
def create_response(result, validation=None, pass_reasons=None, fail_reasons=None,
    ...
    return {
        ...
        "additionalInfo": {
            ...
            "metadata": {"evaluatedAt": datetime.utcnow().isoformat() + "Z", "schemaVersion": "1.0", "transformationId": "isSPFConfigured", "vendor": "Trellix Email Security", "category": "Email Security"}
        }
    }
...
def transform(input):
    ...
    try:
        ...
        spf = config.get("spf", config.get("spfEnabled", config.get("spf_verification", None)))
        if spf is True:
            result = True
