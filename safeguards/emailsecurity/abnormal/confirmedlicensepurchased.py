def transform(input):
    ...
    Parameters:
        input (dict): The JSON data containing Abnormal Security API response
    ...
    try:
        ...
        if 'organization_id' in input or 'organizationId' in input:
            license_purchased = True
            license_details['organizationId'] = input.get('organization_id', input.get('organizationId', ''))
