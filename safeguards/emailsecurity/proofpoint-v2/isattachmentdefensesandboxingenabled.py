"""
Transformation: isAttachmentDefenseSandboxingEnabled
Vendor: Proofpoint  |  Category: Email Security
Evaluates: attachment_defense_sandboxing feature is enabled.
"""
import json
...
def create_response(result, validation=None, pass_reasons=None, fail_reasons=None,
    ...
    return {
        ...
        "additionalInfo": {
            ...
            "metadata": {"evaluatedAt": datetime.utcnow().isoformat() + "Z", "schemaVersion": "1.0", "transformationId": "isAttachmentDefenseSandboxingEnabled", "vendor": "Proofpoint", "category": "Email Security"}
        }
    }
...
def evaluate(data):
    ...
    try:
        ...
        result = _affirmative_signal(data, ['attachment_defense_sandboxing', 'attachmentDefenseSandboxing'], require_all=False)
        return {"isAttachmentDefenseSandboxingEnabled": result}

    except Exception as e:
        return {"isAttachmentDefenseSandboxingEnabled": False, "error": str(e)}


def transform(input):
    criteriaKey = "isAttachmentDefenseSandboxingEnabled"
    try:
