...
Evaluates: smtp_discovery AND outbound_relaying are enabled as proxy controls.
"""
import json
...
def create_response(result, validation=None, pass_reasons=None, fail_reasons=None,
    ...
    return {
        ...
        "additionalInfo": {
            ...
            "metadata": {"evaluatedAt": datetime.utcnow().isoformat() + "Z", "schemaVersion": "1.0", "transformationId": "isSMTPAuthDisabled", "vendor": "Proofpoint", "category": "Email Security"}
        }
    }
...
def evaluate(data):
    ...
    try:
        ...
        result = _affirmative_signal(data, ['smtp_discovery', 'outbound_relaying'], require_all=True)
        return {"isSMTPAuthDisabled": result}
