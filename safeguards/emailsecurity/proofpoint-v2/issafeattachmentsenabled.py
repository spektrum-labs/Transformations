...
Evaluates: attachment_defense feature is enabled.
"""
import json
...
def create_response(result, validation=None, pass_reasons=None, fail_reasons=None,
    ...
    return {
        ...
        "additionalInfo": {
            ...
            "metadata": {"evaluatedAt": datetime.utcnow().isoformat() + "Z", "schemaVersion": "1.0", "transformationId": "isSafeAttachmentsEnabled", "vendor": "Proofpoint", "category": "Email Security"}
        }
    }
...
def evaluate(data):
    ...
    try:
        ...
        result = _affirmative_signal(data, ['attachment_defense', 'attachmentDefense'], require_all=False)
        return {"isSafeAttachmentsEnabled": result}
