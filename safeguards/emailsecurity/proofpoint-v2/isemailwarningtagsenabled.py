"""
Transformation: isEmailWarningTagsEnabled
Vendor: Proofpoint  |  Category: Email Security
Evaluates: email_warning_tags feature is enabled.
"""
import json
...
def create_response(result, validation=None, pass_reasons=None, fail_reasons=None,
    ...
    return {
        ...
        "additionalInfo": {
            ...
            "metadata": {"evaluatedAt": datetime.utcnow().isoformat() + "Z", "schemaVersion": "1.0", "transformationId": "isEmailWarningTagsEnabled", "vendor": "Proofpoint", "category": "Email Security"}
        }
    }
...
def evaluate(data):
    ...
    try:
        ...
        result = affirmative_signal(data, ['email_warning_tags', 'emailWarningTags'], require_all=False)
        return {"isEmailWarningTagsEnabled": result}

    except Exception as e:
        return {"isEmailWarningTagsEnabled": False, "error": str(e)}


def transform(input):
    criteriaKey = "isEmailWarningTagsEnabled"
    try:
