...
Evaluates: instant_replay feature is enabled.
"""
import json
...
def create_response(result, validation=None, pass_reasons=None, fail_reasons=None,
    ...
    return {
        ...
        "additionalInfo": {
            ...
            "metadata": {"evaluatedAt": datetime.utcnow().isoformat() + "Z", "schemaVersion": "1.0", "transformationId": "isMailboxAuditingEnabled", "vendor": "Proofpoint", "category": "Email Security"}
        }
    }
...
def evaluate(data):
    ...
    try:
        ...
        result = _affirmative_signal(data, ['instant_replay', 'instantReplay'], require_all=False)
        return {"isMailboxAuditingEnabled": result}
