...
Evaluates: DLP feature is enabled as a proxy for outbound mail control.
"""
import json
...
def create_response(result, validation=None, pass_reasons=None, fail_reasons=None,
    ...
    return {
        ...
        "additionalInfo": {
            ...
            "metadata": {"evaluatedAt": datetime.utcnow().isoformat() + "Z", "schemaVersion": "1.0", "transformationId": "isAutoForwardDisabled", "vendor": "Proofpoint", "category": "Email Security"}
        }
    }
...
def evaluate(data):
    ...
    try:
        ...
        result = _affirmative_signal(data, ['dlp', 'DLP'], require_all=False)
        return {"isAutoForwardDisabled": result}
