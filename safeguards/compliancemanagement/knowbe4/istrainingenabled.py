...
Evaluates: Whether at least one training campaign is active
"""
import json
...
def create_response(result, validation=None, pass_reasons=None, fail_reasons=None,
    ...
    return {
        ...
        "additionalInfo": {
            ...
            "metadata": {"evaluatedAt": datetime.utcnow().isoformat() + "Z", "schemaVersion": "1.0", "transformationId": "isTrainingEnabled", "vendor": "KnowBe4", "category": "Compliance Management"}
        }
    }
...
def evaluate(data):
    ...
    try:
        ...
        active = [c for c in campaigns if c.get('status') == 'In Progress']
        return {"isTrainingEnabled": len(active) > 0, "activeCampaigns": len(active), "totalCampaigns": len(campaigns)}
