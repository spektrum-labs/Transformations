...
def create_response(result, validation=None, pass_reasons=None, fail_reasons=None,
    ...
    return {
        ...
        "additionalInfo": {
            ...
            "metadata": {"evaluatedAt": datetime.utcnow().isoformat() + "Z", "schemaVersion": "1.0", "transformationId": "isRetentionPolicySet", "vendor": "Elasticsearch", "category": "SIEM"}
        }
    }
    ...
    try:
        ...
        if not isinstance(data, dict):
            return create_response(
                ...
                fail_reasons=["isRetentionPolicySet check failed"]
            )
        policies = data
