"""
Transformation: hasCloudConnectorsConfigured
Vendor: Blumira
Category: SIEM

Evaluates hasCloudConnectorsConfigured for Blumira
"""
...
def create_response(result, validation=None, pass_reasons=None, fail_reasons=None,
    ...
    return {
        ...
        "additionalInfo": {
            ...
            "metadata": {"evaluatedAt": datetime.utcnow().isoformat() + "Z", "schemaVersion": "1.0", "transformationId": "hasCloudConnectorsConfigured", "vendor": "Blumira", "category": "SIEM"}
        }
    }


def transform(input):
    criteriaKey = "hasCloudConnectorsConfigured"
