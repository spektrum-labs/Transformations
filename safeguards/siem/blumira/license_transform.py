...
Evaluates confirmedLicensePurchased for Blumira
"""
...
def create_response(result, validation=None, pass_reasons=None, fail_reasons=None,
    ...
    return {
        ...
        "additionalInfo": {
            ...
            "metadata": {"evaluatedAt": datetime.utcnow().isoformat() + "Z", "schemaVersion": "1.0", "transformationId": "confirmedLicensePurchased", "vendor": "Blumira", "category": "SIEM"}
        }
    }
...
def transform(input):
    ...
    try:
        ...
        return create_response(
            ...
            result={"confirmedLicensePurchased": is_licensed},
