...
Evaluates confirmedLicensePurchased for Ardoq
"""
...
def create_response(result, validation=None, pass_reasons=None, fail_reasons=None,
    ...
    return {
        ...
        "additionalInfo": {
            ...
            "metadata": {"evaluatedAt": datetime.utcnow().isoformat() + "Z", "schemaVersion": "1.0", "transformationId": "confirmedLicensePurchased", "vendor": "Ardoq", "category": "DevSecOps"}
        }
    }
...
def transform(input):
    ...
    try:
        ...
        if not result:
            ...
            org = data.get("organization", data.get("org", ""))
            if email or org:
                result = True
                status = "active"
