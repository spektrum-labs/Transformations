...
Evaluates: Whether the customer has at least one active PHISH3D phishing campaign configured.
"""
import json
...
def create_response(result, validation=None, pass_reasons=None, fail_reasons=None,
    ...
    return {
        ...
        "additionalInfo": {
            ...
            "metadata": {"evaluatedAt": datetime.utcnow().isoformat() + "Z", "schemaVersion": "1.0", "transformationId": "isPhishingSimulationEnabled", "vendor": "NINJIO", "category": "Security Awareness Training"}
        }
    }
...
def evaluate(data):
    ...
    try:
        ...
        total = len(campaigns)
        if total == 0:
            return {"isPhishingSimulationEnabled": False, "activeCampaignCount": 0, "totalCampaigns": 0}

        # Active phishing campaign statuses
