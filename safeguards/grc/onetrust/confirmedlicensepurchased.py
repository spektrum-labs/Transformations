...
def transform(input):
    """
    Evaluates confirmedLicensePurchased for OneTrust

    Checks: Whether the OneTrust account returns a valid authenticated user profile
    API Source: {baseURL}/api/access/v2/me
    Pass Condition: A valid user profile is returned confirming active access
