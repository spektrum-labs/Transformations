...
def transform(input):
    ...
    Checks: Whether IT risk entries exist with classification and scoring
    API Source: {baseURL}/api/riskmanagement/v2/risks
    Pass Condition: At least 1 risk exists with a classification or score assigned
