...
@551b2b54 plus 23 Trend Vision One inventory-check tests); then 242 after
the 77 Check Point Harmony Email Atlas-check tests (measured on e800b0e4 + this change).
FLOOR is 242. Raise it when tests are added; lowering it is a claim
